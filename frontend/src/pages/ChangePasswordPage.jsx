          ...
          <div className="card-body">
            <div className="form-group">
              ...
              <div style={{ position: 'relative' }}>
                ...
                />
                <button type="button" onClick={() => setShowOld(!showOld)} style={{ position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text-muted)', display: 'flex' }}>
