...
import { GraduationCap, Clock, Inbox, UserCheck, Search } from 'lucide-react';
    ...
    <div className="card">
      ...
      <div className="card-body">
        ...
        <div className="grid-2">
          <div>
            <div style={{ fontWeight: 700, marginBottom: 8, fontSize: 13, display: 'flex', alignItems: 'center', gap: 6 }}><UserCheck size={14} /> Giảng viên hướng dẫn</div>
          ...
          <div>
            <div style={{ fontWeight: 700, marginBottom: 8, fontSize: 13, display: 'flex', alignItems: 'center', gap: 6 }}><Search size={14} /> Giảng viên phản biện</div>
            {thesis.reviewer ? (
        ...
        <div>
          ...
          <div style={{ background: 'linear-gradient(135deg, var(--ou-blue-dark), var(--ou-blue-mid))', borderRadius: 16, padding: '28px 32px', marginBottom: 20, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            ...
            <div style={{ textAlign: 'right' }}>
              <GraduationCap size={44} color="rgba(255,255,255,0.7)" />
...
function SinhvienDashboard() {
  ...
  return (
    <MainLayout pageTitle={activeTab?.label || 'Sinh viên'} breadcrumb={`Sinh viên / ${activeTab?.label || ''}`}>
        ...
        <Route index element={
          thesis ? (
            ...
            <div style={{ textAlign: 'center', padding: 60 }}>
              <Inbox size={56} style={{ margin: '0 auto 16px', color: '#CBD5E1' }} />
